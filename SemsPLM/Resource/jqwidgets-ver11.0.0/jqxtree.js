    ...
    $.extend($.jqx._jqxTree.prototype, {
        ...
        _parseItem: function (item) {
            ...
            if (item.type != null && item.type != undefined && item.type.length > 0) {
                html += ' item-type="' + item.type + '" ';
            }

            if (item.checkitemtypes != null && item.checkitemtypes != undefined && item.checkitemtypes.length > 0) {
                html += ' item-checkitemtypes="' + item.checkitemtypes.join(",") + '" ';
            }
            var id = "";
        ...
        _createItem: function (element) {
			...
			//modify by ihjung
            var type = element.getAttribute('item-type');
            var checkitemtypes = element.getAttribute('item-checkitemtypes');
			...
			//modify by ihjung
            listTag.removeAttribute('item-type');
            listTag.removeAttribute('item-checkitemtypes');
			...
			//modify by ihjung
            treeItem.type = type;
            treeItem.checkitemtypes = checkitemtypes;
            ...
            if (this.checkboxes) {
                if (this.host.jqxCheckBox) {
                    //modify by ihjung
                    if (treeItem.checkitemtypes != null && treeItem.checkitemtypes != undefined && treeItem.checkitemtypes.length > 0) {
                        if (treeItem.checkitemtypes.indexOf(treeItem.type) > -1) {
                            var checkbox = $('<div tabIndex=0 class="chkbox"/>');
