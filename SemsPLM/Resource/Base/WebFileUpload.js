    ...
    FileUpload.prototype = {
        ...
        init: function (wrap) {
            ...
            this.FileGrid = $(FileList).jqxGrid({
                ...
                columns: [
                    {
                        text: '제목', datafield: 'OrgNm', resizable: true, align: 'center', cellsalign: 'left', cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties) {
                    ...
                    { text: '작성자', datafield: 'CreateUsNm', width: CellCreateUsNm, align: 'center', cellsalign: 'center', },
                    { text: '작성일', datafield: 'CreateDt', width: CellCreateDt, align: 'center', cellsalign: 'center', cellsformat: 'yyyy-MM-dd' },
                    { text: '', datafield: '', width: CellButton, align: 'center', cellsalign: 'center', cellsrenderer: GridCellFileBtn },
                ]
            });
